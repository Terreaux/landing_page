import { ConstructionVisionSection } from '@/components/landing/ConstructionVisionSection';
import { HeroChainOfThought } from '@/components/landing/HeroChainOfThought';
...
export function ServicePageContent({
  ...
  const heroContainerClass = showComputerVisionRuntime
    ...
    : showAgenticRuntime
      ...
      : 'mx-auto w-[min(980px,92vw)] py-16 md:py-24';
