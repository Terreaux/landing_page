...
import { HighlightCard } from '@/islands/HighlightCard';
import { Logo } from '@/islands/Logo';
import { cn } from '@/lib/utils';

const highlightedTransform = {
  0: 0,
  1: -100,
  2: -170,
};
    ...
    >
      ...
      >
        <div className="flex min-w-[300px] shrink-0 flex-col gap-2 lg:gap-5">
          ...
          <div className='text-start text-sm text-[#cbd7c4] sm:text-base'>{description}</div>
        </div>
        {children}
      </div>
    </HighlightCard>
...
export const WorkflowSection = () => {
  ...
  return (
    <section className="px-5 pt-20 sm:pt-24">
      <h2 className="font-display mx-auto mt-3 max-w-xl text-3xl font-semibold text-[#f7f9f2] sm:text-4xl">
                  ...
                  >
                    {highlighted === index && (
                      <motion.div
                        ...
                        className="pointer-events-none absolute top-0 -left-7 h-full w-full rounded bg-soil-900/60"
                      />
                    )}
          ...
          <div
            ...
            style={{
              transform: `translateY(${
                highlightedTransform[highlighted as keyof typeof highlightedTransform]
              }px)`,
            }}
          >
